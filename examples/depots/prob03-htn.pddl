( define ( htn-problem probname )
  ...
  ( :tasks
    ( make-on crate005 pallet000 )
    ( make-on crate043 crate005 )
    ( make-on crate000 crate043 )
    ( make-on crate006 crate000 )
    ( make-on crate001 pallet001 )
    ( make-on crate019 crate001 )
    ( make-on crate069 crate019 )
    ( make-on crate035 pallet002 )
    ( make-on crate003 crate035 )
    ( make-on crate037 crate003 )
    ( make-on crate077 crate037 )
    ( make-on crate068 crate077 )
    ( make-on crate059 crate068 )
    ( make-on crate039 pallet003 )
    ( make-on crate029 crate039 )
    ( make-on crate052 crate029 )
    ( make-on crate050 crate052 )
    ( make-on crate024 crate050 )
    ( make-on crate057 crate024 )
    ( make-on crate053 crate057 )
    ( make-on crate079 crate053 )
    ( make-on crate041 pallet004 )
    ( make-on crate016 crate041 )
    ( make-on crate046 crate016 )
    ( make-on crate031 crate046 )
    ( make-on crate061 crate031 )
    ( make-on crate063 crate061 )
    ( make-on crate067 pallet005 )
    ( make-on crate071 crate067 )
    ( make-on crate078 crate071 )
    ( make-on crate021 crate078 )
    ( make-on crate030 crate021 )
    ( make-on crate009 pallet006 )
    ( make-on crate051 crate009 )
    ( make-on crate056 crate051 )
    ( make-on crate065 crate056 )
    ( make-on crate042 crate065 )
    ( make-on crate075 crate042 )
    ( make-on crate014 pallet007 )
    ( make-on crate012 crate014 )
    ( make-on crate002 crate012 )
    ( make-on crate070 pallet008 )
    ( make-on crate049 crate070 )
    ( make-on crate022 crate049 )
    ( make-on crate054 crate022 )
    ( make-on crate040 pallet009 )
    ( make-on crate017 crate040 )
    ( make-on crate010 crate017 )
    ( make-on crate025 crate010 )
    ( make-on crate033 crate025 )
    ( make-on crate034 crate033 )
    ( make-on crate062 crate034 )
    ( make-on crate027 crate062 )
    ( make-on crate023 crate027 )
    ( make-on crate032 crate023 )
    ( make-on crate072 crate032 )
    ( make-on crate007 pallet010 )
    ( make-on crate048 crate007 )
    ( make-on crate008 crate048 )
    ( make-on crate013 crate008 )
    ( make-on crate066 crate013 )
    ( make-on crate060 pallet011 )
    ( make-on crate058 crate060 )
    ( make-on crate076 crate058 )
    ( make-on crate064 crate076 )
    ( make-on crate073 pallet012 )
    ( make-on crate044 crate073 )
    ( make-on crate055 crate044 )
    ( make-on crate038 crate055 )
    ( make-on crate074 crate038 )
    ( make-on crate015 crate074 )
    ( make-on crate028 crate015 )
    ( make-on crate020 crate028 )
    ( make-on crate011 pallet013 )
    ( make-on crate004 crate011 )
    ( make-on crate047 pallet014 )
    ( make-on crate045 crate047 )
    ( make-on crate036 crate045 )
    ( make-on crate018 pallet015 )
    ( make-on crate026 crate018 )
  )
)
