( define ( htn-problem probname )
  ...
  ( :tasks
    ...
    ( DELIVER-PKG p002 l000-003 )
    ( DELIVER-PKG p003 l003-002 )
    ( DELIVER-PKG p004 l002-003 )
    ( DELIVER-PKG p005 l001-004 )
    ( DELIVER-PKG p006 l001-004 )
    ( DELIVER-PKG p007 l001-002 )
    ( DELIVER-PKG p008 l002-005 )
    ( DELIVER-PKG p009 l001-003 )
    ( DELIVER-PKG p010 l004-001 )
    ( DELIVER-PKG p011 l005-002 )
    ( DELIVER-PKG p012 l000-002 )
    ( DELIVER-PKG p013 l004-000 )
    ( DELIVER-PKG p014 l000-002 )
    ( DELIVER-PKG p015 l002-001 )
    ( DELIVER-PKG p016 l002-003 )
    ( DELIVER-PKG p017 l004-002 )
